...
export const Exchange = {
  ...
  getDeploymentPolicy: {name: 'Get Deployment Policy By Name', path: 'orgs/${orgid}/business/policies/${businesPolicy}', method: 'GET', type: 'deploymentPolicy', description: 'Returns the deployment policy with the specified id. Can be run by a user, node, or agbot.'},
  ...
  deleteDeploymentPolicy: {name: 'Delete Deployment Policy By Name', path: 'orgs/${orgid}/business/${businesPolicy}', method: 'DELETE', type: 'deploymentPolicy', description: ''},
