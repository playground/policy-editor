...
export const Exchange = {
  ...
  addNode: {name: 'Add/Update Node', path: 'orgs/${orgid}/nodes/${nodeid}', method: 'PUT', type: 'node'},
  getNode: {name: 'Get Node By Name', path: 'orgs/${orgid}/nodes/${nodeid}', method: 'GET', type: 'node'},
  getNodes: {name: 'Get All Nodes', path: 'orgs/${orgid}/nodes', method: 'GET', type: 'node', run: true},
  deleteNode: {name: 'Delete Node By Name', path: 'orgs/${orgid}/nodes/${nodeid}', method: 'DELETE', type: 'node'},
